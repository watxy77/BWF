package com.bwf.core.beans.proxy.qlexpress;

import com.bwf.core.beans.PropertyValue;
import com.bwf.core.beans.proxy.NodeProxy;

public class QlexpressNodeProxy implements NodeProxy {
    private PropertyValue propertyValue;
    private NodeProxy nextHandler;

    public QlexpressNodeProxy(PropertyValue propertyValue) {
    ...
    public void invoke(Object object) {
        System.out.println("【qlexpress】" + propertyValue.getValue());
        if(nextHandler != null){
